...
<!-- Editable table -->
<div class="card">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">Humidity Data</h3>
  <div class="card-body">
    <div id="table" class="table-editable">
<form method="post">
      <span class="table-add float-right mb-3 mr-2"><a href="huma.php" class="text-success">
      ...
      <table class="table table-bordered table-responsive-md table-striped text-center">
        ...
        <tr>
          ...
          <td class="pt-3-half" contenteditable="true"><?=$hum?>&nbsp;</td>
        </tr>
        <?php
      }
      ?>
